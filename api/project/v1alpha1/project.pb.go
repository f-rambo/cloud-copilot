...
var file_api_project_v1alpha1_project_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xda,
	...
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f, 0x6d, 0x6f, 0x63, 0x6b, 0x42, 0x1f, 0x5a, 0x1d, 0x61,
...
var file_api_project_v1alpha1_project_proto_depIdxs = []int32{
	...
	3, // 6: project.v1alpha1.ProjectService.Ping:output_type -> project.v1alpha1.Msg
	3, // 7: project.v1alpha1.ProjectService.Save:output_type -> project.v1alpha1.Msg
	1, // 8: project.v1alpha1.ProjectService.Get:output_type -> project.v1alpha1.Project
	4, // 9: project.v1alpha1.ProjectService.List:output_type -> project.v1alpha1.ProjectList
	3, // 10: project.v1alpha1.ProjectService.Delete:output_type -> project.v1alpha1.Msg
	1, // 11: project.v1alpha1.ProjectService.GetProjectMockData:output_type -> project.v1alpha1.Project
