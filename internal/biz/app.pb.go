...
type App struct {
	...
	Versions    []*AppVersion `json:"versions,omitempty" gorm:"-" protobuf:"bytes,7,rep,name=versions,proto3"`                                                             // @gotags: gorm:"-"
...
type AppReleaseResource struct {
	...
	// @gofield: gorm.Model
	Id         int64    `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" gorm:"column:id;primaryKey;AUTO_INCREMENT"`                                          // @gotags: gorm:"column:id;primaryKey;AUTO_INCREMENT"
	ReleaseId  int64    `json:"release_id,omitempty" gorm:"column:release_id; default:0; NOT NULL; index" protobuf:"varint,2,opt,name=release_id,json=releaseId,proto3"` // @gotags: gorm:"column:release_id; default:0; NOT NULL; index"
	Name       string   `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty" gorm:"column:name; default:''; NOT NULL"`                                         // @gotags: gorm:"column:name; default:''; NOT NULL"
...
type AppRelease struct {
	...
	Manifest    string                `json:"manifest,omitempty" gorm:"column:manifest; default:''; NOT NULL" protobuf:"bytes,11,opt,name=manifest,proto3"`                             // @gotags: gorm:"column:manifest; default:''; NOT NULL"
	...
	Wait        bool                  `json:"wait,omitempty" gorm:"column:wait; default:false; NOT NULL" protobuf:"varint,16,opt,name=wait,proto3"`                                     // @gotags: gorm:"column:wait; default:false; NOT NULL"
