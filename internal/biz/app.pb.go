...
type AppRelease struct {
	...
	AppId       int64                 `gorm:"column:app_id; default:0; NOT NULL; index" protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`                  // @gotags: gorm:"column:app_id; default:0; NOT NULL; index"
	...
	ClusterId   int64                 `json:"cluster_id,omitempty" gorm:"column:cluster_id; default:0; NOT NULL; index" protobuf:"varint,5,opt,name=cluster_id,json=clusterId,proto3"`  // @gotags: gorm:"column:cluster_id; default:0; NOT NULL; index"
	...
	Status      AppReleaseSatus       `gorm:"column:status; default:0; NOT NULL" protobuf:"varint,10,opt,name=status,proto3,enum=biz.app.AppReleaseSatus" json:"status,omitempty"`      // @gotags: gorm:"column:status; default:0; NOT NULL"
	...
	Notes       string                `json:"notes,omitempty" gorm:"column:notes; default:''; NOT NULL" protobuf:"bytes,12,opt,name=notes,proto3"`                                      // @gotags: gorm:"column:notes; default:''; NOT NULL"
