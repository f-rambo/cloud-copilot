...
type AppReleaseResource struct {
	...
	Status     []string `gorm:"-" protobuf:"bytes,8,rep,name=status,proto3" json:"status,omitempty"`
	gorm.Model          // @gotags: gorm:"-"
}
...
type AppRelease struct {
	...
	ClusterId   int64                 `gorm:"column:cluster_id; default:0; NOT NULL; index" protobuf:"varint,5,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`  // @gotags: gorm:"column:cluster_id; default:0; NOT NULL; index"
