...
type AppRelease struct {
	...
	ProjectId   int64                 `gorm:"column:project_id; default:0; NOT NULL; index" protobuf:"varint,6,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`  // @gotags: gorm:"column:project_id; default:0; NOT NULL; index"
	...
	Namespace   string                `json:"namespace,omitempty" gorm:"column:namespace; default:''; NOT NULL" protobuf:"bytes,8,opt,name=namespace,proto3"`                           // @gotags: gorm:"column:namespace; default:''; NOT NULL"
	...
	ConfigFile  string                `json:"config_file,omitempty" gorm:"column:config_file; default:''; NOT NULL" protobuf:"bytes,10,opt,name=config_file,json=configFile,proto3"`    // @gotags: gorm:"column:config_file; default:''; NOT NULL"
	...
	Resources   []*AppReleaseResource `gorm:"-" protobuf:"bytes,17,rep,name=resources,proto3" json:"resources,omitempty"`
	gorm.Model                        // @gotags: gorm:"-"
}
...
var file_internal_biz_app_proto_rawDesc = []byte{
	...
	0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x02, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74,
