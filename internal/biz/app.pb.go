...
type AppVersion struct {
	...
	Version       string `json:"version,omitempty" gorm:"column:version; default:''; NOT NULL; index" protobuf:"bytes,5,opt,name=version,proto3"`                                  // @gotags: gorm:"column:version; default:''; NOT NULL; index"
...
type AppReleaseResource struct {
	...
	Events     []string `json:"events,omitempty" gorm:"-" protobuf:"bytes,7,rep,name=events,proto3"`                                                                     // @gotags: gorm:"-"
