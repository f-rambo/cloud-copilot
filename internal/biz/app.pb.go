...
type App struct {
	...
	AppTypeId   int64         `json:"app_type_id,omitempty" gorm:"column:app_type_id; default:0; NOT NULL" protobuf:"varint,4,opt,name=app_type_id,json=appTypeId,proto3"` // @gotags: gorm:"column:app_type_id; default:0; NOT NULL"
...
type AppReleaseResource struct {
	...
	Name       string   `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty" gorm:"column:name; default:''; NOT NULL"`                                         // @gotags: gorm:"column:name; default:''; NOT NULL"
	Kind       string   `gorm:"column:kind; default:''; NOT NULL" protobuf:"bytes,4,opt,name=kind,proto3" json:"kind,omitempty"`                                         // @gotags: gorm:"column:kind; default:''; NOT NULL"
