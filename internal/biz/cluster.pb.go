...
type Cluster struct {
	...
	Status               ClusterStatus    `gorm:"column:status; default:0; NOT NULL" protobuf:"varint,8,opt,name=status,proto3,enum=biz.cluster.ClusterStatus" json:"status,omitempty"`                                          // @gotags: gorm:"column:status; default:0; NOT NULL"
	Type                 ClusterType      `protobuf:"varint,9,opt,name=type,proto3,enum=biz.cluster.ClusterType" json:"type,omitempty" gorm:"column:type; default:0; NOT NULL"`                                                  // @gotags: gorm:"column:type; default:0; NOT NULL"
	Level                ClusterLevel     `json:"level,omitempty" gorm:"column:level; default:0; NOT NULL" protobuf:"varint,10,opt,name=level,proto3,enum=biz.cluster.ClusterLevel"`                                             // @gotags: gorm:"column:level; default:0; NOT NULL"
	...
	Connections          string           `gorm:"column:connections; default:''; NOT NULL" protobuf:"bytes,13,opt,name=connections,proto3" json:"connections,omitempty"`                                                         // @gotags: gorm:"column:connections; default:''; NOT NULL"
	CertificateAuthority string           `json:"certificate_authority,omitempty" gorm:"column:certificate_authority; default:''; NOT NULL" protobuf:"bytes,14,opt,name=certificate_authority,json=certificateAuthority,proto3"` // @gotags: gorm:"column:certificate_authority; default:''; NOT NULL"
	...
	AccessId             string           `gorm:"column:access_id; default:''; NOT NULL" protobuf:"bytes,18,opt,name=access_id,json=accessId,proto3" json:"access_id,omitempty"`                                                 // @gotags: gorm:"column:access_id; default:''; NOT NULL"
	...
	MasterUser           string           `gorm:"column:master_user; default:''; NOT NULL" protobuf:"bytes,21,opt,name=master_user,json=masterUser,proto3" json:"master_user,omitempty"`                                         // @gotags: gorm:"column:master_user; default:''; NOT NULL"
...
type Node struct {
	...
	Role        NodeRole   `json:"role,omitempty" gorm:"column:role; default:0; NOT NULL" protobuf:"varint,7,opt,name=role,proto3,enum=biz.cluster.NodeRole"`                    // @gotags: gorm:"column:role; default:0; NOT NULL"
...
type NodeGroup struct {
	...
	Name             string        `json:"name,omitempty" gorm:"column:name; default:''; NOT NULL" protobuf:"bytes,2,opt,name=name,proto3"`                                                              // @gotags: gorm:"column:name; default:''; NOT NULL"
	Type             NodeGroupType `protobuf:"varint,3,opt,name=type,proto3,enum=biz.cluster.NodeGroupType" json:"type,omitempty" gorm:"column:type; default:0; NOT NULL"`                               // @gotags: gorm:"column:type; default:0; NOT NULL"
	Image            string        `json:"image,omitempty" gorm:"column:image; default:''; NOT NULL" protobuf:"bytes,4,opt,name=image,proto3"`                                                           // @gotags: gorm:"column:image; default:''; NOT NULL"
	...
	Arch             string        `gorm:"column:arch; default:''; NOT NULL" protobuf:"bytes,7,opt,name=arch,proto3" json:"arch,omitempty"`                                                              // @gotags: gorm:"column:arch; default:''; NOT NULL"
	...
	RootDeviceName   string        `protobuf:"bytes,14,opt,name=root_device_name,json=rootDeviceName,proto3" json:"root_device_name,omitempty" gorm:"column:root_device_name; default:''; NOT NULL"`     // @gotags: gorm:"column:root_device_name; default:''; NOT NULL"
	...
	MaxSize          int32         `protobuf:"varint,17,opt,name=max_size,json=maxSize,proto3" json:"max_size,omitempty" gorm:"column:max_size; default:0; NOT NULL"`                                    // @gotags: gorm:"column:max_size; default:0; NOT NULL"
	...
	NodePrice        float32       `protobuf:"fixed32,21,opt,name=node_price,json=nodePrice,proto3" json:"node_price,omitempty" gorm:"column:node_price; default:0; NOT NULL"`                           // @gotags: gorm:"column:node_price; default:0; NOT NULL"
	PodPrice         float32       `gorm:"column:pod_price; default:0; NOT NULL" protobuf:"fixed32,22,opt,name=pod_price,json=podPrice,proto3" json:"pod_price,omitempty"`                               // @gotags: gorm:"column:pod_price; default:0; NOT NULL"
	Zone             string        `json:"zone,omitempty" gorm:"column:zone; default:''; NOT NULL" protobuf:"bytes,23,opt,name=zone,proto3"`                                                             // @gotags: gorm:"column:zone; default:''; NOT NULL"
	SubnetIpCidr     string        `json:"subnet_ip_cidr,omitempty" gorm:"column:subnet_ip_cidr; default:''; NOT NULL" protobuf:"bytes,24,opt,name=subnet_ip_cidr,json=subnetIpCidr,proto3"`             // @gotags: gorm:"column:subnet_ip_cidr; default:''; NOT NULL"
	NodeInitScript   string        `protobuf:"bytes,25,opt,name=node_init_script,json=nodeInitScript,proto3" json:"node_init_script,omitempty" gorm:"column:cloud_init_script; default:''; NOT NULL"`    // @gotags: gorm:"column:cloud_init_script; default:''; NOT NULL"
...
type BostionHost struct {
	...
	Image            string     `json:"image,omitempty" gorm:"column:image; default:''; NOT NULL" protobuf:"bytes,3,opt,name=image,proto3"`                                                           // @gotags: gorm:"column:image; default:''; NOT NULL"
	...
	Arch             string     `gorm:"column:arch; default:''; NOT NULL" protobuf:"bytes,6,opt,name=arch,proto3" json:"arch,omitempty"`                                                              // @gotags: gorm:"column:arch; default:''; NOT NULL"
	...
	InternalIp       string     `gorm:"column:internal_ip; default:''; NOT NULL" protobuf:"bytes,11,opt,name=internal_ip,json=internalIp,proto3" json:"internal_ip,omitempty"`                        // @gotags: gorm:"column:internal_ip; default:''; NOT NULL"
...
type CloudResource struct {
	...
	Type         ResourceType     `json:"type,omitempty" gorm:"column:type; default:0; NOT NULL" protobuf:"varint,5,opt,name=type,proto3,enum=biz.cluster.ResourceType"`                // @gotags: gorm:"column:type; default:0; NOT NULL"
	...
	SubResources []*CloudResource `protobuf:"bytes,8,rep,name=sub_resources,json=subResources,proto3" json:"sub_resources,omitempty" gorm:"-"`                                          // @gotags: gorm:"-"
	gorm.Model
}
...
type SecurityGroup struct {
	...
	VpcId       string `gorm:"column:vpc_id; default:''; NOT NULL" protobuf:"bytes,4,opt,name=vpc_id,json=vpcId,proto3" json:"vpc_id,omitempty"`                         // @gotags: gorm:"column:vpc_id; default:''; NOT NULL"
...
var file_internal_biz_cluster_proto_rawDesc = []byte{
	...
	0x7a, 0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x22, 0xc8, 0x08, 0x0a, 0x07, 0x43, 0x6c,
	...
	,
	...
	,
	...
	0x0a, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x49, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x75,
	0x73, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12,
	0x29, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x62, 0x69, 0x7a,
	...
	0x64, 0x65, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x6e, 0x6f, 0x64, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x1f,
	...
	0x1d, 0x0a, 0x0a, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xa7,
	0x06, 0x0a, 0x09, 0x4e, 0x6f, 0x64, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x0e, 0x0a, 0x02,
	...
	,
	...
	,
	...
	0x69, 0x70, 0x74, 0x18, 0x19, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6e, 0x6f, 0x64, 0x65, 0x49,
	0x6e, 0x69, 0x74, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63,
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0xac, 0x03, 0x0a, 0x0b, 0x42, 0x6f, 0x73,
	...
	0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0x89, 0x02, 0x0a, 0x0d, 0x43, 0x6c, 0x6f, 0x75,
	...
	0x63, 0x65, 0x73, 0x22, 0x84, 0x02, 0x0a, 0x0d, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79,
	...
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x15, 0x0a, 0x06, 0x76,
	0x70, 0x63, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x70, 0x63,
	0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x70, 0x6f,
	0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x69, 0x6e, 0x67, 0x72, 0x65, 0x73,
	0x73, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x65, 0x67, 0x72, 0x65, 0x73, 0x73, 0x5f,
	0x70, 0x6f, 0x72, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x65, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63,
	...
	,
	...
	,
	...
	0x0a, 0x03, 0x56, 0x50, 0x43, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x55, 0x42, 0x4e, 0x45,
	0x54, 0x10, 0x02, 0x12, 0x14, 0x0a, 0x10, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x4e, 0x45, 0x54, 0x5f,
	0x47, 0x41, 0x54, 0x45, 0x57, 0x41, 0x59, 0x10, 0x03, 0x12, 0x0f, 0x0a, 0x0b, 0x4e, 0x41, 0x54,
	0x5f, 0x47, 0x41, 0x54, 0x45, 0x57, 0x41, 0x59, 0x10, 0x04, 0x12, 0x0f, 0x0a, 0x0b, 0x52, 0x4f,
	0x55, 0x54, 0x45, 0x5f, 0x54, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x05, 0x12, 0x12, 0x0a, 0x0e, 0x53,
	...
	,
