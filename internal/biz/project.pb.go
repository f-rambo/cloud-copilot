...
type Technology struct {
	...
	BusinessId int64  `json:"business_id,omitempty" gorm:"column:business_id; default:0; NOT NULL" protobuf:"varint,3,opt,name=business_id,json=businessId,proto3"` // @gotags: gorm:"column:business_id; default:0; NOT NULL"
	gorm.Model
}
...
type Project struct {
	...
	Namespace          string        `json:"namespace,omitempty" gorm:"column:namespace; default:''; NOT NULL" protobuf:"bytes,5,opt,name=namespace,proto3"`                                                       // @gotags: gorm:"column:namespace; default:''; NOT NULL"
	...
	Business           []*Business   `gorm:"-" protobuf:"bytes,7,rep,name=business,proto3" json:"business,omitempty"`                                                                                              // @gotags: gorm:"-"
