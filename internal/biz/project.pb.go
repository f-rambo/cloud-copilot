...
type Project struct {
	...
	LimitCpu        int32  `json:"limit_cpu,omitempty" gorm:"column:limit_cpu; default:0; NOT NULL" protobuf:"varint,7,opt,name=limit_cpu,json=limitCpu,proto3"`                              // @gotags: gorm:"column:limit_cpu; default:0; NOT NULL"
	...
	ImageRepository string `gorm:"column:image_repository; default:''; NOT NULL" protobuf:"bytes,12,opt,name=image_repository,json=imageRepository,proto3" json:"image_repository,omitempty"` // @gotags: gorm:"column:image_repository; default:''; NOT NULL"
	gorm.Model
}
