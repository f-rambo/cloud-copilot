...
type Business struct {
	...
	Technologys []*Technology `gorm:"-" protobuf:"bytes,4,rep,name=technologys,proto3" json:"technologys,omitempty"`
...
type Project struct {
	...
	Status             ProjectStatus `gorm:"column:status; default:0; NOT NULL" protobuf:"varint,6,opt,name=status,proto3,enum=biz.project.ProjectStatus" json:"status,omitempty"`                                 // @gotags: gorm:"column:status; default:0; NOT NULL"
	Business           []*Business   `protobuf:"bytes,7,rep,name=business,proto3" json:"business,omitempty" gorm:"-"`                                                                                              // @gotags: gorm:"-"
	BusinessTechnology string        `gorm:"column:business_technology; default:''; NOT NULL" protobuf:"bytes,8,opt,name=business_technology,json=businessTechnology,proto3" json:"business_technology,omitempty"` // @gotags: gorm:"column:business_technology; default:''; NOT NULL"
	gorm.Model
}
