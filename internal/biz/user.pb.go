...
type User struct {
	...
	Password    string       `gorm:"column:password; default:''; NOT NULL" protobuf:"bytes,4,opt,name=password,proto3" json:"password,omitempty"`                                             // @gotags: gorm:"column:password; default:''; NOT NULL"
