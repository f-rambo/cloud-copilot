...
type User struct {
	...
	Password    string       `json:"password,omitempty" gorm:"column:password; default:''; NOT NULL" protobuf:"bytes,4,opt,name=password,proto3"`                                             // @gotags: gorm:"column:password; default:''; NOT NULL"
	...
	AccessToken string       `json:"access_token,omitempty" gorm:"-" protobuf:"bytes,6,opt,name=access_token,json=accessToken,proto3"`                                                        // @gotags: gorm:"-"`
