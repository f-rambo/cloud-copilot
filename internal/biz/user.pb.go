...
type User struct {
	...
	WorkspaceId          int64        `json:"workspace_id,omitempty" gorm:"column:workspace_id; default:0; NOT NULL" protobuf:"varint,8,opt,name=workspace_id,json=workspaceId,proto3"`                                        // @gotags: gorm:"column:workspace_id; default:0; NOT NULL"
	GitRepositoryToken   string       `protobuf:"bytes,9,opt,name=git_repository_token,json=gitRepositoryToken,proto3" json:"git_repository_token,omitempty" gorm:"column:gitrepository_token; default:''; NOT NULL"`          // @gotags: gorm:"column:gitrepository_token; default:''; NOT NULL"
	ImageRepositoryToken string       `json:"image_repository_token,omitempty" gorm:"column:imagerepository_token; default:''; NOT NULL" protobuf:"bytes,10,opt,name=image_repository_token,json=imageRepositoryToken,proto3"` // @gotags: gorm:"column:imagerepository_token; default:''; NOT NULL"
	gorm.Model
}
...
func (x *User) GetWorkspaceId() int64 {
	if x != nil {
...
func (x *User) GetGitRepositoryToken() string {
	if x != nil {
		return x.GitRepositoryToken
	}
	return ""
}

func (x *User) GetImageRepositoryToken() string {
	if x != nil {
		return x.ImageRepositoryToken
	}
	return ""
}
...
func (x *Role) Reset() {
	*x = Role{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_biz_user_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *UserRole) Reset() {
	*x = UserRole{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_biz_user_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserRole) Descriptor() ([]byte, []int) {
	return file_internal_biz_user_proto_rawDescGZIP(), []int{2}
}
...
type ResourcePermissions struct {
	...
	// @gofield: gorm.Model
	Id          int64  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" gorm:"column:id;primaryKey;AUTO_INCREMENT"`                       // @gotags: gorm:"column:id;primaryKey;AUTO_INCREMENT"
	Verbs       string `json:"verbs,omitempty" gorm:"column:verbs; default:''; NOT NULL" protobuf:"bytes,2,opt,name=verbs,proto3"`                   // @gotags: gorm:"column:verbs; default:''; NOT NULL"
	Resources   string `json:"resources,omitempty" gorm:"column:resources; default:''; NOT NULL" protobuf:"bytes,3,opt,name=resources,proto3"`       // @gotags: gorm:"column:resources; default:''; NOT NULL"
...
func (x *ResourcePermissions) Reset() {
	*x = ResourcePermissions{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_biz_user_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResourcePermissions) Descriptor() ([]byte, []int) {
	return file_internal_biz_user_proto_rawDescGZIP(), []int{3}
}
...
func (x *ResourcePermissions) GetVerbs() string {
	if x != nil {
		return x.Verbs
	}
	return ""
...
func (x *ResourcePermissions) GetResources() string {
	if x != nil {
		return x.Resources
	}
	return ""
...
func (x *ResourcePermissions) GetPermissions() string {
	if x != nil {
...
var file_internal_biz_user_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x22, 0xed, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x28, 0x0e, 0x32, 0x14, 0x2e, 0x62, 0x69, 0x7a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73,
	...
	,
	...
	,
...
var file_internal_biz_user_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_internal_biz_user_proto_goTypes = []any{
	...
	(*Role)(nil),                // 3: biz.user.Role
	(*UserRole)(nil),            // 4: biz.user.UserRole
	(*ResourcePermissions)(nil), // 5: biz.user.ResourcePermissions
}
...
func file_internal_biz_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_biz_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Role); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_biz_user_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_internal_biz_user_proto_msgTypes[3].Exporter = func(v any, i int) any {
